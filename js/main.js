...
/* harmony import */ var _components_choices_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/choices.min.js */ "./src/js/components/choices.min.js");
...
!function (e, t) {
  ...
  function me(e) {
    let t = null,
      ...
      s = 1,
      o = null;
    if (oe(e) || se(e)) n = e, t = ge(e), i = ve(e);else {
      ...
      this.chunks.forEach(_ref => {
        ...
        const {
          ...
          if (m) {
            const e = function () {
              let e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
              let t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : ye.minMatchCharLength;
              let i = [],
                n = -1,
                s = -1,
                o = 0;
  ...
  class qe {
    ...
    search(e) {
      ...
      return function (e, _ref2) {
        ...
        ignoreFieldNorm: r
      }), s && c.sort(o), re(t) && t > -1 && (c = c.slice(0, t)), function (e, t) {
        let {
      ...
      const t = Ve(e, this.options),
        i = (e, t, n) => {
          ...
          for (let o = 0, r = e.children.length; o < r; o += 1) {
            ...
            if (r.length) s.push(...r);else if (e.operator === je) return [];
          }
          return s;
        },
        n = {},
        s = [];
      return this._myIndex.records.forEach(_ref5 => {
        let {
          $: e,
          i: o
        } = _ref5;
  ...
  }, qe.config = ye, qe.parseQuery = Ve, function () {
    De.push(...arguments);
  }(class {
    constructor(e) {
      let {
  ...
  return function () {
    ...
    return Object.defineProperty(e, "defaults", {
      ...
      return void 0 === e && (e = !0), this._stopSearch(), e && this.passedElement.element.replaceChildren(""), this.itemList.element.replaceChildren(""), this.choiceList.element.replaceChildren(""), this._clearNotice(), this._store.reset(), this._lastAddedChoiceId = 0, this._lastAddedGroupId = 0, this._searcher.reset(), this;
      ...
      if (this._isTextElement) {
        if (this._presetChoices = i.items.map(function (e) {
          ...
          var n = this.passedElement.value.split(i.delimiter).map(function (e) {
            return W(e, !1, t.config.allowHtmlUserInput);
          });
      ...
      var e = this.config,
        t = e.maxItemCount,
        i = e.maxItemText;
      return !(!e.singleModeForMultiSelect && t > 0 && t <= this._store.items.length && (this.choiceList.element.replaceChildren(""), this._notice = void 0, this._displayNotice("function" == typeof i ? i(t) : i, ee), 1));
          ...
          if (this._canAddItems()) {
            ...
            this._store.withTxn(function () {
              if (!(r = i._findAndSelectChoiceByValue(n, !0))) {
                ...
                i._addChoice(W(n, !1, i.config.allowHtmlUserInput), !0, !0), r = !0;
              }
      ...
      if (t || this._isSelectOneElement) {
        ...
        var r = 40 === o || 34 === o ? 1 : -1,
          c = void 0;
        if (e.metaKey || 34 === o || 33 === o) c = this.dropdown.element.querySelector(r > 0 ? "".concat(Ye, ":last-of-type") : Ye);else {
      ...
      if (e.id) {
        ...
        var t = this._notice;
        t && t.type === Y && this._clearNotice(), this.passedElement.triggerEvent(m, this._getChoiceForOutput(e));
      }
...
// Transformation of elements of header to in mobile menu

new transfer_elements__WEBPACK_IMPORTED_MODULE_3__["default"]({
  sourceElement: document.querySelector('.header__profile'),
  breakpoints: {
    1023.98: {
      targetElement: document.querySelector('.header__mobile-profile')
    }
  }
});
new transfer_elements__WEBPACK_IMPORTED_MODULE_3__["default"]({
  sourceElement: document.querySelector('.header__lang'),
  breakpoints: {
    1023.98: {
      targetElement: document.querySelector('.header__mobile-lang')
    }
  }
});
new transfer_elements__WEBPACK_IMPORTED_MODULE_3__["default"]({
  sourceElement: document.querySelector('.menu-logged'),
  breakpoints: {
    480.98: {
...
new transfer_elements__WEBPACK_IMPORTED_MODULE_3__["default"]({
  sourceElement: document.querySelector('.summary'),
  breakpoints: {
    767.98: {
      targetElement: document.querySelector('.submit')
    }
  }
});
if (document.querySelectorAll('.header').length > 0) {
  ...
  const btnAuth = document.querySelector('.header__profile');
...
const headerLang = document.querySelector('.js-choice');
const choices = new Choices(headerLang, {
  searchEnabled: false,
  itemSelectText: '',
  shouldSort: false
});
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const menuButtons = document.querySelectorAll('[data-js-dropdown-button]');
  const dropDownMenus = document.querySelectorAll('[data-js-dropdown-menu]');
  menuButtons.forEach(btn => {
    btn.addEventListener('click', e => {
      let currentButton = e.currentTarget;
      let currentDropdown = currentButton.closest('.menu-logged__item').querySelector('[data-js-dropdown-menu]');
      menuButtons.forEach(btn => {
        if (btn !== currentButton) {
          btn.classList.remove('menu-logged__btn-active');
        }
      });
      ...
      btn.classList.toggle('menu-logged__btn-active');
  ...
  if (document.querySelectorAll('.product').length > 0) {
    ...
    const buttonsPay = document.querySelector('.buttons-pay');
    const progressContainer = document.querySelector('.progress-container');
    const stepsContainer = document.querySelector(".steps-container");
    const stepsTop = document.querySelector(".step-top");
    document.documentElement.style.setProperty("--steps", stepIndicators.length);
    let currentStep = 0;
    let screenWidth = window.matchMedia('(max-width:767.98px)');
    ...
    const updateButtons = () => {
      //btnBooking.hidden = currentStep === 0;
      btnContinue.hidden = currentStep >= steps.length - 1;
      buttonsPay.hidden = !btnContinue.hidden;
    };
    ...
    btnBooking.addEventListener("click", e => {
      ...
      stepsTop.style.display = 'none';
      progressContainer.classList.remove('hide');
      btnContinue.classList.remove('hide');
      btnBooking.classList.add('hide');
    });
...
if (document.querySelectorAll('.footer').length > 0) {
  const date = new Date();
  const elementForCurrentYear = document.querySelector('.footer__get-year');
  const currentYear = date.getFullYear();
  elementForCurrentYear.innerHTML = currentYear;
}
})();
